...
func resolveSubnetByName(
  subnets resourceInput<'Microsoft.Network/virtualNetworks@2025-05-01'>.properties.subnets,
  subnetName string
...
func resolveSubnetPrefixByName(
  subnets resourceInput<'Microsoft.Network/virtualNetworks@2025-05-01'>.properties.subnets,
  subnetName string
) string => resolveSubnetByName(subnets, subnetName).properties.addressPrefix
