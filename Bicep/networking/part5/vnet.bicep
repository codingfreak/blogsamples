...
resource ruleRdp 'Microsoft.Network/networkSecurityGroups/securityRules@2025-05-01' = {
  name: 'allow-rdp'
  parent: nsg
  properties: {
    access: 'Allow'
...
resource ruleIcmp 'Microsoft.Network/networkSecurityGroups/securityRules@2025-05-01' = {
